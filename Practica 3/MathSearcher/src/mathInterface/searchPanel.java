...
public class searchPanel extends javax.swing.JPanel {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(hitsTable1, javax.swing.GroupLayout.DEFAULT_SIZE, 528, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    public void search(){
        ...
        try {
            ...
            if(findTypeBox.getSelectedItem().toString().equals("Proximidad")){
                hits=mainSearcher.search(Integer.parseInt(distanceBox.getText()), findType, field, value, fieldNames, fieldValues,advancedPanel1.GetField(),advancedPanel1.GetRange(), 5000);
            }
            else if(findTypeBox.getSelectedItem().toString().equals("Exacta")){
                hits=mainSearcher.search(0, "Proximidad", field, value, fieldNames, fieldValues,advancedPanel1.GetField(),advancedPanel1.GetRange(), 5000);
            }
            else{
                hits=mainSearcher.search(0, findType, field, value, fieldNames, fieldValues,advancedPanel1.GetField(),advancedPanel1.GetRange(), 5000);
            }
        } catch (IOException ex) {
            Logger.getLogger(searchPanel.class.getName()).log(Level.SEVERE, null, ex);
